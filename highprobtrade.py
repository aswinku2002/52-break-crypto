...
def run_bot():
    ...
    print("===== STRATEGY WITHOUT DPO =====")
    print("📊 TIMEFRAME: 15-minute candles")
    print("📈 DONCHIAN CHANNEL: 52 periods")
    print("\n📊 REVERSAL SIGNALS (CHOP > 60):")
    print(f"🟢 BUY REVERSAL: Bottom 5% + RSI < 30 + ATR < ATR_SMA20")
    print(f"🔴 SELL REVERSAL: Top 5% + RSI > 70 + ATR < ATR_SMA20")
    print("\n📈 TREND SIGNALS (CHOP < 40):")
    print(f"🟢 BUY TREND: Top 2% + RSI > 60 + ATR > ATR_SMA20")
    print(f"🔴 SELL TREND: Bottom 2% + RSI < 40 + ATR > ATR_SMA20")
    print("\n📊 ATR LOGIC:")
    ...
    send_alert(f"✅ Bot Started on {EXCHANGE.name.capitalize()}\n\n"
               f"📊 Donchian Channel (52) + CHOP (14) + RSI (14) + ATR (14) + ATR_SMA20\n"
               f"⏱️ Timeframe: 15-minute candles\n"
               f"❌ DPO: REMOVED from all signals\n\n"
               f"🟢 BUY REVERSAL:\n"
    ...
    while True:
        for symbol in available_symbols:
            try:
                ...
                # ==============================================
                # CONDITION 1: BUY REVERSAL (DPO REMOVED)
                # CHOP > 60 & RSI < 30 & Bottom 5% & ATR < ATR_SMA20
                # ==============================================
                ...
                # ==============================================
                # CONDITION 2: SELL REVERSAL (DPO REMOVED)
                # CHOP > 60 & RSI > 70 & Top 5% & ATR < ATR_SMA20
                # ==============================================
                ...
                # ==============================================
                # CONDITION 3: BUY TREND (DPO REMOVED)
                ...
                # ==============================================
                # CONDITION 4: SELL TREND (DPO REMOVED)
